...
<input type="text" placeholder="introduce a ride name" id="nameEdit">					
				</div>
		</div>
		<br>
		...
		<div class="container">
				...
				<div class="col-xs- col-sm- col-md- col-lg-6">
                   ...
                   <input type="text" placeholder="Introduce the Start From" id="startEdit">					
				</div>
					<div class="col-xs-12 col-sm-6 col-md-6">
						...
						<input type="text" placeholder="Introduce the End" id="endEdit">
					</div>
		</div>
		<br>
		<div class="container">
				...
				<div class="col-xs- col-sm- col-md- col-lg-12">
					...
					<div class="form-group">
						...
						<textarea class="form-control" rows="5" id="commentEdit"></textarea>
					</div>
				</div>
			<h2><b>When</b></h2>
			<div class="container">
					...
					<div class="col-xs- col-sm- col-md- col-lg-6">
						...
						<input type="text" placeholder="Introduce an hour" id="departureEdit">
						<p>
							<b>Estimate Arrival</b>
						</p>
						<input type="text" placeholder="Introduce an hour" id="estimateEdit">
					...
					<input type="text" placeholder="Introduce the days" id="daysEdit">
